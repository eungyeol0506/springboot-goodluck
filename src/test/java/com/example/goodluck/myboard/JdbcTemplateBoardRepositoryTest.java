...
//             // when
//             MyBoard result1 = boardRepository.findByNo(selectNo).get();
//             List<MyBoard> result2 = boardRepository.findAll(start, end);
...
//             MyBoard board = boardRepository.findByNo(5L).get();
//             board.setBoardTitle(title);
//             board.setContents(contents);
//             board.setUpdateDate(LocalDate.now());
//             //when
//             boardRepository.update(board);
//             MyBoard result = boardRepository.findByNo(5L).get();
//             //then
...
//             // given
//             Long boardNo = 1L;
//             MyBoard board = boardRepository.findByNo(boardNo).get();
//             // when
...
//             // when
//             boardRepository.remove(2L);
//             MyBoard board = boardRepository.findByNo(2L).orElse(null);
//             // then
